...
" MAIN MENU: Open -
syntax match praatCommand "\(Read Strings from raw text file\(:\)\@=\)"
...
syntax match praatCommand "\(Save as \(WAV\|FLAC\|AIFF\) file\(:\)\@=\)"
...
syntax match praatCommand "\(Get \(start\|end\) time of interval\(:\)\@=\)"
