...
syntax match praatCommand "\(Shift times to\|Shift times by\)"
syntax match praatCommand "\(Scale times to\|Scale times by\)"
...
syntax match praatCommand "\(Insert interval tier\|Insert point tier\)"
syntax match praatCommand "\(Append row\|Append column\)" 
syntax match praatCommand "\(Remove row\|Remove column\)"
syntax match praatCommand "\(Remove right boundary\|Remove left boundary\)"
syntax match praatCommand "\(Insert boundary\|Set interval text\)"
